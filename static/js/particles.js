...
(function () {
  ...
  class Particle {
    constructor() {
      ...
      const colorPalette = [
        { color: 'rgba(2, 132, 199,', glow: 'rgba(2, 132, 199, 0.4)' },    // Sky Azure
        { color: 'rgba(79, 70, 229,', glow: 'rgba(79, 70, 229, 0.4)' },    // Apple Indigo
        { color: 'rgba(147, 51, 234,', glow: 'rgba(147, 51, 234, 0.4)' },  // Vision Violet
        { color: 'rgba(219, 39, 119,', glow: 'rgba(219, 39, 119, 0.4)' },  // Pink Amber
        { color: 'rgba(16, 185, 129,', glow: 'rgba(16, 185, 129, 0.4)' }   // Emerald
      ];
